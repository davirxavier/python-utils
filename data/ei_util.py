...
ei_weights_urls = {
    ...
    "no_top": {
        "3": {
            "96": {
                "0.35": "transfer-learning-weights/keras/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_0.35_96_no_top.h5"
            },
            "128": {
                "0.35": "transfer-learning-weights/keras/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_0.35_128_no_top.h5"
            },
            "160": {
                "0.35": "transfer-learning-weights/keras/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_0.35_160_no_top.h5"
            },
            "192": {
                "0.35": "transfer-learning-weights/keras/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_0.35_192_no_top.h5"
            },
            "224": {
                "0.35": "transfer-learning-weights/keras/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_0.35_224_no_top.h5"
            }
        }
    }
}
...
def download_or_get_weights_mobilenetV2(top, color_channels, input_size, alpha):
    uri = ei_weights_urls.get("top" if top else "no_top", {}).get(str(color_channels), {}).get(str(input_size), {}).get(str(alpha), "")
    if uri == "":
